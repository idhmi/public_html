...
(function ($) {
	...
	if ($("body").hasClass("tt-transition")) {
		...
		function HideLoad() {
			var tl_transitOut = gsap.timeline();
				 ...
				 if ($(".ph-appear-2").length) {
					tl_transitOut.from(".ph-appear-2", { duration: 2, autoAlpha: 0, stagger: 0.3, ease: Expo.easeOut, clearProps:"all" }, 4);
					tl_transitOut.from(".ph-desappear-3", { autoAlpha: 1 }, 4.2);
				}
   ...
   // ============================================================================
	...
	$('a[href^="#"]')
		...
		// 	var $offset = 0;
		// }
		var $offset = $(".header-fixed").height()+50;
	...
	// animating comp section
	// ==================
	var section = $('.competition-li');
...
//                 $element.addClass('maldssnC_0');
// 				console.log('on screen');
//             } else {
//                 $element.removeClass('maldssnC_0');
